...
const App = () => {
  ...
  return (
    <div className="h-s grid place-items-center text-white">
      ...
      <div className='pro'>
        <h1 className='title'>Banish Mealtime Guesswork with<br />with Chef<span className='bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent'>Master</span></h1>
      </div>
